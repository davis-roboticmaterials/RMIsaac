...
# os.chdir("/home/davis/isaac-sdk-2020.2/sdk/apps/robotic_materials/robot_control")
os.getcwd()
...
class RMIsaacBridge(object):
    ...
    def initialize_app(self):
        ...
        app.load(filename="//packages/ros_bridge/apps:ros_to_perception_subgraph", prefix="ros_perception")
